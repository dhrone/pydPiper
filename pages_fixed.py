...
WIDGETS = {
	...
	'title': { 'type':'text', 'format':'{0}', 'variables':['title'], 'font':'small','varwidth':True,'effect':('scroll','left',1,20,'onloop',3,80) },
	'artist': { 'type':'text', 'format':'{0}', 'variables':['artist'], 'font':'small','varwidth':True,'effect':('scroll','left',1,20,'onloop',3,80)},
	'album': { 'type':'text', 'format':'{0}', 'variables':['album'], 'font':'small','varwidth':True,'effect':('scroll','left',1,20,'onloop',3,80)},
	...
	'weather': { 'type':'text', 'format':'{0}', 'variables':['outside_conditions|capitalize'], 'font':'large','varwidth':True, 'size':(50,16), 'effect':('scroll','left',1,20,'onloop',3,50)},
...
CANVASES = {
	'playartist': { 'widgets': [ ('artist',0,6), ('nowplaying',0,0), ('nowplayingdata',30,0), ('songprogress',0,15) ], 'size':(80,16) },
	'playartist_radio': { 'widgets': [ ('artist',0,0),  ('radio',0,8), ('elapsed',50,8) ], 'size':(80,16) },
	'playalbum': { 'widgets': [ ('album',0,6), ('nowplaying',0,0), ('nowplayingdata',30,0), ('songprogress',0,15) ], 'size':(80,16) },
	'playalbum_radio': { 'widgets':  [ ('album',0,0), ('radio',0,8), ('elapsed',50,8) ], 'size':(80,16) },
	'playtitle': { 'widgets':  [ ('title',0,6), ('nowplaying',0,0), ('nowplayingdata',30,0), ('songprogress',0,15) ], 'size':(80,16) },
