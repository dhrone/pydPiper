...
WIDGETS = {
	...
	'time': { 'type':'text', 'format':'{0}', 'variables':['utc|timezone+Europe/Paris|strftime+%H:%M'], 'font':'small', 'just':'center', 'varwidth':True, 'size':(50,16) },
	...
	'ready': { 'type':'text', 'format':"Ready\n{0}", 'variables':['utc|timezone+Europe/Paris|strftime+%H:%M'], 'font':'small', 'varwidth':True, 'size':(80,5), 'just':'center' },
	...
	'systemvars': { 'type':'text', 'format':'{0}c  Disk {1}%\n{2}', 'variables':['current_tempc', 'disk_availp','utc|timezone+Europe/Paris|strftime+%H:%M'], 'font':'small', 'varwidth':True, 'effect':('scroll','left',1,20,'onstart',3,80) },
	'ip': { 'type':'text', 'format':'{0}\n{1}', 'variables':['ip','utc|timezone+Europe/Paris|strftime+%H:%M'], 'font':'small', 'just':'center', 'varwidth':True, 'size':(50,16) }
}
...
CANVASES = {
	'playartist': { 'widgets': [ ('artist',0,0), ('position',0,7), ('songprogress',0,15) ], 'size':(80,16) },
	'playtitle': { 'widgets':  [ ('title',0,0), ('position',0,7), ('songprogress',0,15) ], 'size':(80,16) },
	'playmeta': { 'widgets': [ ('metadata',0,0), ('position',0,7), ('songprogress',0,15) ], 'size':(80,16) },
	'playartist_radio': { 'widgets': [ ('artist',0,0), ('position',0,7), ('radio',40,0), ('songprogress', 0,15) ], 'size':(80,16) },
	'playalbum_radio': { 'widgets':  [ ('album',0,7), ('position',0,7), ('radio',40,0), ('songprogress', 0,15) ], 'size':(80,16) },
	'playtitle_radio': { 'widgets':  [ ('title',0,7), ('position',0,7), ('radio',40,0), ('songprogress',0,15) ], 'size':(80,16) },
	...
	'blank': { 'widgets': [ ('position',0,7), ('songprogress',0,15) ], 'size':(80,16) },
